...
**Current ACF Version: 0.25** — the umbrella version = the Refinement changelog version (FB-020). Projects record this in CLAUDE.md's `ACF Version:` line; the installed skill declares the current value.
